...
df = pd.read_csv("ChocolateWeightMMT1a.txt", parse_dates = ['Reading'],
...
ax.plot(df_array.time, df_array['weight'],'o', df_array.time, line)
...
ax.set(xlabel="Time[s]",
       ylabel="Weight[g]",
       title="ChocolateWeightMMT1a.txt");

plt.savefig('fil.png', dpi=600)
